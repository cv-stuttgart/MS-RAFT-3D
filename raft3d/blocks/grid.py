...
class GridFactor:
    ...
    def factorAAt(self, sym_factor=None, sym_shape=None):
    ...
    def solveAAt(self, b=None, sym_factor=None, sym_shape=None):
        if self.chols is None:
            _, sym_factor, sym_shape = self.factorAAt(sym_factor, sym_shape)
        ...
        return x.reshape(*b.shape), sym_factor, sym_shape